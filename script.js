...
function updateDisplay() {
    ...
    // Update counter
    document.getElementById("counter").textContent = `CHARACTER ${currentIndex + 1}/5`;
    
    // Update level display
    const levelPadded = String(currentIndex + 1).padStart(2, '0');
    document.getElementById("levelDisplay").textContent = levelPadded;
}
